...
const TextCursor: React.FC<TextCursorProps> = ({
  ...
  useEffect(() => {
    // Listen on the window (positions are still computed relative to the
    // container's rect) so the overlay can stay pointer-events-none and let
    // clicks through to the hero's buttons.
